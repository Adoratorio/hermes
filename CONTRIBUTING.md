...
Use [GitHub Issues](https://github.com/Adoratorio/hermes/issues). Include the package version,
...
Cover wheel delta modes, keyboard groups, editable elements, native shortcuts, touch cancellation and listener cleanup. Check input inside nested roots and open shadow roots. Preserve default multipliers and page sizing; changes to input sensitivity require an agreed breaking release.
